...
TRADE_SYMBOLS = [
    ...
    'LINKUSDT','UNIUSDT','LTCUSDT','BCHUSDT','XLMUSDT','TRXUSDT','ETCUSDT','NEARUSDT','ATOMUSDT','FILUSDT',
    'ICPUSDT','GRTUSDT','EOSUSDT','AAVEUSDT','SANDUSDT','THETAUSDT','AXSUSDT','VETUSDT','SNXUSDT','KSMUSDT',
    'KLAYUSDT','FTMUSDT','CAKEUSDT','ENJUSDT','ZILUSDT','CHZUSDT','MKRUSDT','FTTUSDT','SUSHIUSDT','ALGOUSDT',
    'CROUSDT','BSVUSDT','WAVESUSDT','COMPUSDT','NEOUSDT','CHSBUSDT','RUNEUSDT','CELRUSDT','AROUSDT','ROSEUSDT',
    'HNTUSDT','CELOUSDT','ENSUSDT','ZRXUSDT','BATUSDT','QTUMUSDT','GALAUSDT','ONEUSDT','MANAUSDT','FLOWUSDT',
    'STXUSDT','DYDXUSDT','IMXUSDT','LDOUSDT','SNXUSDT','CRVUSDT','LRCUSDT','ARUSDT','MATICUSDT','OKBUSDT',
    'MINAUSDT','IOSTUSDT','CHZUSDT','KAVAUSDT','GTCUSDT','QNTUSDT','QNTUSDT','ALPHAUSDT','GLMUSDT','RAYUSDT',
    'ENSUSDT','ANTUSDT','BLZUSDT','ROSEUSDT','LETUSDT','AKROUSDT','BATUSDT','COMPUSDT','ATOMUSDT','ADAUSDT'
]
...
def check_entry(symbol):
    ...
    if last['adx'] < MIN_ADX:
        return None
    long_score = sum([last['rsi']<40, last['macd_diff']>0,
                      last['c']>last['ema'], last['stoch']<20])
    short_score = sum([last['rsi']>60, last['macd_diff']<0,
                       last['c']<last['ema'], last['stoch']>80])
