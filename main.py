...
SYMBOLS = [
    ...
    "MKRUSDT", "SNXUSDT", "CRVUSDT", "COMPUSDT", "TOMOUSDT", "LINAUSDT", "OCEANUSDT", "1000SHIBUSDT", "BAKEUSDT", "BELUSDT",
    "CTSIUSDT", "KAVAUSDT", "YFIUSDT", "REEFUSDT", "VETUSDT", "BICOUSDT", "RAYUSDT", "ANKRUSDT", "AKROUSDT", "HOTUSDT",
    "LITUSDT", "CELRUSDT", "TLMUSDT", "C98USDT", "BNTUSDT", "ICXUSDT", "QTUMUSDT", "KNCUSDT", "ZENUSDT", "PERPUSDT",
    "MTLUSDT", "JOEUSDT", "SFPUSDT", "SKLUSDT", "STMXUSDT", "ARDRUSDT", "GTCUSDT", "TRUUSDT", "ALPHAUSDT", "KLAYUSDT",
    "FETUSDT", "HOOKUSDT", "IDEXUSDT", "CTKUSDT", "GALUSDT", "LEVERUSDT", "XEMUSDT", "OMGUSDT", "BTSUSDT", "TVKUSDT"
]
